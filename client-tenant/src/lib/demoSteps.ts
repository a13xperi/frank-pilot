...
// owner = which tab fires the step. 'tenant' = client-tenant funnel (this app),
// 'staff' = client (PM console). Each tab's overlay lights only its own rows;
// other-owner rows render dimmer for narrative context.
...
export const THIS_OWNER: 'tenant' | 'staff' = 'tenant';
