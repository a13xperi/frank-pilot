...
export function makeState(overrides: Partial<ApplyState> = {}): ApplyState {
  ...
  const base: ApplyState = {
    ...
    grossAnnualIncome: null, setGrossAnnualIncome: noop,
    qualifyingAmiTier: null, setQualifyingAmiTier: noop,
    qualifyingAmiCalculatedAt: null, setQualifyingAmiCalculatedAt: noop,
    qualifyingHouseholdSize: null, setQualifyingHouseholdSize: noop,
